...
module Phlexing
  class NameSuggestorTest < ActiveSupport::TestCase
    test "should suggest name for excluded tags" do
    ...
    test "should suggest name for tag name" do
    ...
    test "should suggst name when id and class attribute is present" do
    ...
    test "should suggest name with multiple top-level nodes" do
    ...
    test "should suggest name for attributes with dashes" do
    ...
    test "should suggest name for ivars" do
    ...
    test "should suggest name for locals" do
      assert_equal "UserComponent", Phlexing::NameSuggestor.suggest(%(<div id="post"><%= user.name %></div>))
      assert_equal "UserComponent", Phlexing::NameSuggestor.suggest(%(<div class="posts"><%= user.name %></div>))
      assert_equal "UserComponent", Phlexing::NameSuggestor.suggest(%(<div id="post" class="posts"><%= user.name %></div>))
      assert_equal "UserComponent", Phlexing::NameSuggestor.suggest(%(<div><%= user.name %></div>))
    ...
    test "should suggest name id attribute and ivar/locals are present" do
    ...
    test "should suggest name when class attribute and ivar/locals are present" do
    ...
    test "should suggest name when text nodes are present" do
    ...
    test "should suggest name when only top-level erb-nodes are present" do
